    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <form method="get" action="" class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary btn-lg w-100 fw-bold">تحديث التقرير</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><span class="small text-muted fw-bold"><?php echo $percent; ?>%</span></td>
                    ...
                    <tfoot class="bg-light border-top border-2">
                        <tr>
                            ...
                            <td class="pe-4 py-3 text-end fw-bold text-primary h4 mb-0">
                                <?php echo number_format($grand_total, 2); ?>
                            </td>
                        </tr>
                    </tfoot>
